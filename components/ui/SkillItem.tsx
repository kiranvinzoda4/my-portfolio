...
export default function SkillItem({ name, iconId }: Skill) {
  ...
  return (
    <div className="group flex min-w-0 items-center gap-3 rounded-xl border border-card-border bg-card-solid/50 px-4 py-3 transition-all duration-300 hover:-translate-y-0.5 hover:border-accent/30 hover:shadow-lg hover:shadow-accent-glow">
